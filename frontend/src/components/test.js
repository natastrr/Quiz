...
export class Test {
    ...
    showQuestion() {
        this.passButtonElement.disabled = false;
        this.passButtonElement.querySelector('img').src = '/images/small-arrow.svg';
    ...
    chooseAnswer() {
        this.nextButtonElement.removeAttribute('disabled');
        this.passButtonElement.disabled = true;
        this.passButtonElement.querySelector('img').src = '/images/small-gray-arrow.svg';
    }
